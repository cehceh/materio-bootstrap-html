...
class UnitConversions(BasicData):
    ...
    val_2 = models.CharField(
        max_length=20,
        verbose_name=_('Value'),
        blank=True, null=True
    )
    unit_3 = models.CharField(
        max_length=50,
        #choices=((obj, obj)for obj in UnitNames.objects.values_list('name', flat=True)),
        verbose_name=_("Unit Name"),
        blank=True, null=True
    )
    val_3 = models.CharField(
        max_length=20,
        verbose_name=_('Value'),
        blank=True, null=True
    )
    unit_4 = models.CharField(
        max_length=50,
        #choices=((obj, obj)for obj in UnitNames.objects.values_list('name', flat=True)),
        verbose_name=_("Unit Name"),
        blank=True, null=True
    )
    val_4 = models.CharField(
        max_length=20,
        verbose_name=_('Value'),
        blank=True, null=True
    )
    unit_5 = models.CharField(
        max_length=50,
        #choices=((obj, obj)for obj in UnitNames.objects.values_list('name', flat=True)),
        verbose_name=_("Unit Name"),
        blank=True, null=True
    )
    val_5 = models.CharField(
        max_length=20,
        verbose_name=_('Value'),
        blank=True, null=True
    )
    
    main_unit = models.BooleanField(default=False)
    
    updated_user = models.ForeignKey(
        "users.CustomUser",
        related_name="user_make_unit_conversions_changes",
        blank=True, null=True,
        on_delete=models.CASCADE,
    )
    ...
    class Meta:
        app_label = "configurations"
        verbose_name = "unit_conversions"
        verbose_name_plural = "UnitConversions"
        indexes = [
            # models.Index(fields=["name"]),
            ...
            ##UnitConversions
            models.Index(fields=["unit_1"]),
            models.Index(fields=["val_1"]),
            models.Index(fields=["unit_2"]),
            models.Index(fields=["val_2"]),
            models.Index(fields=["unit_3"]),
            models.Index(fields=["val_3"]),
            models.Index(fields=["unit_4"]),
            models.Index(fields=["val_4"]),
            models.Index(fields=["unit_5"]),
            models.Index(fields=["val_5"]),
            models.Index(fields=["main_unit"]),

        ]

    def __str__(self):
        return f"{self.unit_1}" 
